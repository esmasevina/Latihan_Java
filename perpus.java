...
public static void pinjamBuku(){
  ...
  input.nextLine();
      ...
      System.out.print("NIM : ");mhs[jmlmhs][0]= input.nextInt();
      System.out.println("1. PSTI");
      System.out.println("2. PGSD");
      System.out.println("3. PGPAUD");
      System.out.println("4. SISTEL");
      ...
      System.out.print(nama[i]+"       ");
       if(mhs[i][1] == 1) {
        System.out.print("PSTI");
          ...
          System.out.print("PGSD");
          }
        else if(mhs[i][1] == 3) {
          System.out.print("PGPAUD");
          }
        else {
          System.out.print("SISTEL");
        }
...
public static void deletejudulBuku() {
  String[] buku = {"hujan", "bumi", "bulan", "matahari", "bintang"};
        System.out.print("Judul buku yang ingin di delete : ");
